...
and in custom scripts e.g. from [Git](https://apps.winbench.org/#Bench.Git).
...
This switch only takes affect, if the [Git app](https://apps.winbench.org/#Bench.Git) is activated.
